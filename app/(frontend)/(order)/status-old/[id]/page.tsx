                    ...
                    <div className="bg-gray-100 p-4 rounded-lg">
                        ...
                        <div className="flex items-center gap-3 mt-3">
                            ...
                            <p className="text-gray-800 text-sm">
                                Jl. Perjuangan, gg. Alam Segar 2 No.2, Sempaja
                                Sel., Kec. Samarinda Utara, Kota Samarinda,
